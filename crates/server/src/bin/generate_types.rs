...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::feishu_bot::FeishuBot::decl(),
        db::models::feishu_bot::CreateFeishuBot::decl(),
        db::models::feishu_bot::UpdateFeishuBot::decl(),
        db::models::feishu_bot_target::FeishuBotTarget::decl(),
        db::models::feishu_bot_target::CreateFeishuBotTarget::decl(),
        db::models::feishu_bot_target::UpdateFeishuBotTarget::decl(),
        db::models::workspace_feishu_binding::WorkspaceFeishuBinding::decl(),
        db::models::workspace_feishu_binding::CreateWorkspaceFeishuBinding::decl(),
        db::models::workspace_feishu_binding::UpdateWorkspaceFeishuBinding::decl(),
        db::models::feishu_conversation::FeishuConversation::decl(),
        db::models::feishu_conversation::CreateFeishuConversation::decl(),
        db::models::feishu_delivery_log::FeishuDeliveryLog::decl(),
        db::models::feishu_delivery_log::CreateFeishuDeliveryLog::decl(),
        server::feishu::types::DiscoveredFeishuTarget::decl(),
        server::feishu::types::FeishuValidationResult::decl(),
        server::feishu::types::SendFeishuMessageInput::decl(),
        server::feishu::types::SendFeishuMessageResult::decl(),
        server::feishu::types::FeishuRuntimeSnapshot::decl(),
