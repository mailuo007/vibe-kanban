...
export const workspacesApi = {
  ...
  listFeishuBindings: async (
    ...
    const response = await makeRequest(
      `/api/workspaces/${attemptId}/feishu/bindings`
    );
  ...
  updateFeishuBinding: async (
    ...
    const response = await makeRequest(
      `/api/workspaces/${attemptId}/feishu/bindings/${bindingId}`,
      {
        method: 'PATCH',
        body: JSON.stringify(data),
      }
  ...
  listFeishuBindableTargets: async (
    ...
    const response = await makeRequest(
      `/api/workspaces/${attemptId}/feishu/bindable-targets`
    );
  ...
  sendFeishuTestMessage: async (
    ...
    const response = await makeRequest(
      `/api/workspaces/${attemptId}/feishu/test-message`,
      {
        method: 'POST',
        body: JSON.stringify(data),
      }
